package libs
{
	...
	public class Clipper extends Sprite
	{
		...
		public function Clipper(parent:*, minWidth:int = 100, minHeight:int = 100, clipRect:Rectangle = null, resizeAble:Boolean = true, limitZoom:Boolean = false, showButton:Boolean = true, cliperSize: Array = null){
			_parent = parent;
			_minWidth = minWidth; 
