package
{
	...
	import baidu.local.MultiUpload;
	import baidu.local.StaticLib;
	import baidu.local.UploadBase64;
	...
	{    
		...
		private function init():void {
			...
			StaticLib.config = {
				...
				'previewWidth': _options["isPreview"] ? (_options["maxSize"] + 15) : 0, //预览头像区域的宽度
		...
		private function _buildUI():void{
			...
			//裁剪框
			_clipper = new Clipper(this, 10, 10, null, true, true, false, _options['cliperSize']);
		...
		private function _getUploadData():BitmapData{
			...
			//_tempBitmapData && _tempBitmapData.dispose();
			//viewBitmapData && viewBitmapData.dispose();
			var viewBitmapData: BitmapData = new BitmapData(_options["maxSize"], _options["maxSize"]);
			viewBitmapData.draw(_tempBitmapData, new Matrix(_options["maxSize"] / _tempBitmapData.width, 0, 0, _options["maxSize"] / _tempBitmapData.height), null, null, null, true);
			
			StaticLib.console('console.log','_bitmapDatawidth:'+_bitmapData.width + ',_bitmapDataheight:'+_bitmapData.height);
